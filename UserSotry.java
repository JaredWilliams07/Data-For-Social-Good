...
//Creates dog array using the text files breeds, size and age
  ...
  //method to get the most popular dog object based on qualifications we found in our data set
...
// finds the youngest dog in the array
